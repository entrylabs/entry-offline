...
EntryStatic.blockInfo = {
    ...
    xbot_servo: {
        ...
        xml:
            "<block type='xbot_servo'><value name='VALUE'><block type='text'><field name='NAME'>90</field></block></value></block>",
        class: 'xbot_motor',
    },
    ...
    xbot_rgb: {
        isNotFor: ['xbot_epor_edge'],
        xml:
            "<block type='xbot_rgb'><value name='ledR'><block type='text'><field name='NAME'>255</field></block></value><value name='ledG'><block type='text'><field name='NAME'>255</field></block></value><value name='ledB'><block type='text'><field name='NAME'>255</field></block></value></block>",
        class: 'xbot_rgb',
    },
    ...
    xbot_lcd: {
        isNotFor: ['xbot_epor_edge'],
        xml:
            "<block type='xbot_lcd'><value name='VALUE'><block type='text'><field name='NAME'>Hello</field></block></value></block>",
        class: 'xbot_sensor',
    },
    ...
    xbot_oneWheel: {
        isNotFor: ['xbot_epor_edge'],
        xml:
            "<block type='xbot_oneWheel'><value name='VALUE'><block type='text'><field name='NAME'>0</field></block></value></block>",
        class: 'xbot_motor',
    },
    ...
    xbot_twoWheel: {
        isNotFor: ['xbot_epor_edge'],
        xml:
            "<block type='xbot_twoWheel'><value name='rightWheel'><block type='text'><field name='NAME'>0</field></block></value><value name='leftWheel'><block type='text'><field name='NAME'>0</field></block></value></block>",
        class: 'xbot_motor',
    },
    ...
    xbot_buzzer: {
        isNotFor: ['xbot_epor_edge'],
        xml:
            "<block type='xbot_buzzer'><field name='OCTAVE'>4</field><value name='VALUE'><block type='text'><field name='NAME'>0.5</field></block></value></block>",
        class: 'xbot_sensor',
    },
    xbot_digitalOutput: {
        isNotFor: ['xbot_epor_edge'],
    ...
    xbot_analogOutput: {
        isNotFor: ['xbot_epor_edge'],
        xml:
            "<block type='xbot_analogOutput'><value name='VALUE'><block type='text'><field name='NAME'>255</field></block></value></block>",
        class: 'xbot_sensor',
    },
    //end of XBOT Blocks added
    //EV3 BLOCK
    ...
    ev3_motor_power: {
        isNotFor: ['EV3'],
        xml:
            "<block type='ev3_motor_power'><value name='VALUE'><block type='number'><field name='NUM'>50</field></block></value></block>",
        class: 'ev3_output',
    },
    ev3_motor_power_on_time: {
        isNotFor: ['EV3'],
        xml:
            "<block type='ev3_motor_power_on_time'><value name='TIME'><block type='number'><field name='NUM'>2</field></block></value><value name='VALUE'><block type='number'><field name='NUM'>50</field></block></value></block>",
        class: 'ev3_output',
    },
    ev3_motor_degrees: {
        isNotFor: ['EV3'],
        xml:
            "<block type='ev3_motor_degrees'><value name='DEGREE'> <block type='angle'></block> </value></block>",
        class: 'ev3_output',
    },
    when_run_button_click: {
    ...
    when_some_key_pressed: {
        xml:
            "<block type='when_some_key_pressed'><field name='VALUE'>67</field></block>",
        class: 'event',
        isNotFor: [],
        usage: ['start'],
    },
    ...
    wait_second: {
        xml:
            "<block type='wait_second'><value name='SECOND'><block type='number'><field name='NUM'>2</field></block></value></block>",
        class: 'delay',
        isNotFor: [],
    ...
    repeat_basic: {
        xml:
            "<block type='repeat_basic'><value name='VALUE'><block type='number'><field name='NUM'>10</field></block></value></block>",
        class: 'repeat',
        isNotFor: [],
        usage: ['repeat'],
    },
    ...
    repeat_while_true: {
        xml:
            "<block type='repeat_while_true'><value name='BOOL'><block type='True'></block> </value> </block>",
        class: 'repeat',
        isNotFor: [],
    ...
    _if: {
        xml:
            "<block type='_if'> <value name='BOOL'> <block type='True'></block> </value> </block>",
        class: 'condition',
        isNotFor: [],
        usage: ['condition'],
    },
    if_else: {
        xml:
            "<block type='if_else'> <value name='BOOL'> <block type='True'></block> </value> </block>",
        class: 'condition',
        isNotFor: [],
        usage: ['condition'],
    },
    ...
    stop_object: {
        ...
        isNotFor: [],
        description:
            '모든 오브젝트 : 모든 오브젝트들이 즉시 실행을 멈춥니다.<br>이 블록 : 이 블록과 연결된 모든 블록들이 즉시 실행을 멈춥니다.<br>이 오브젝트 : 해당 오브젝트의 모든 블록들을 멈춥니다.<br>이 오브젝트의 다른 블록 : 해당 오브젝트 중 이 블록과 연결된 블록은 멈추지 않고 다른 블록들은 멈추게 됩니다.',
    },
    wait_until_true: {
        xml:
            "<block type='wait_until_true'> <value name='BOOL'> <block type='True'></block> </value> </block>",
        class: 'wait',
        isNotFor: [],
        usage: ['condition'],
    },
    ...
    move_direction: {
        xml:
            "<block type='move_direction'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'walk',
        isNotFor: [],
    ...
    move_x: {
        xml:
            "<block type='move_x'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'move_relative',
        isNotFor: [],
        usage: ['coordinate'],
    },
    move_y: {
        xml:
            "<block type='move_y'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'move_relative',
        isNotFor: [],
        usage: ['coordinate'],
    },
    move_xy_time: {
        xml:
            "<block type='move_xy_time'><value name='VALUE1'><block type='number'><field name='NUM'>2</field></block></value><value name='VALUE2'><block type='number'><field name='NUM'>10</field></block></value><value name='VALUE3'><block type='number'><field name='NUM'>10</field></block></value></block>",
        class: 'move_relative',
        isNotFor: [],
        usage: ['coordinate'],
    },
    locate_object_time: {
        xml:
            "<block type='locate_object_time'><value name='VALUE'><block type='number'><field name='NUM'>2</field></block></value></block>",
        class: 'move_absolute',
        isNotFor: [],
        usage: ['coordinate'],
    },
    locate_x: {
        xml:
            "<block type='locate_x'><value name='VALUE'><block type='number'><field name='NUM'>10</field></block></value></block>",
        class: 'move_absolute',
        isNotFor: [],
        usage: ['coordinate'],
    },
    locate_y: {
        xml:
            "<block type='locate_y'><value name='VALUE'><block type='number'><field name='NUM'>10</field></block></value></block>",
        class: 'move_absolute',
        isNotFor: [],
        usage: ['coordinate'],
    },
    locate_xy: {
        xml:
            "<block type='locate_xy'><value name='VALUE1'><block type='number'><field name='NUM'>0</field></block></value><value name='VALUE2'><block type='number'><field name='NUM'>0</field></block></value></block>",
        class: 'move_absolute',
        isNotFor: [],
        usage: ['coordinate'],
    },
    locate_xy_time: {
        xml:
            "<block type='locate_xy_time'><value name='VALUE1'><block type='number'><field name='NUM'>2</field></block></value><value name='VALUE2'><block type='number'><field name='NUM'>10</field></block></value><value name='VALUE3'><block type='number'><field name='NUM'>10</field></block></value></block>",
        class: 'move_absolute',
        isNotFor: [],
        usage: ['coordinate'],
    },
    ...
    rotate_absolute: {
        xml:
            "<block type='rotate_absolute'> <value name='VALUE'> <block type='angle'></block> </value> </block>",
    ...
    rotate_by_time: {
        xml:
            "<block type='rotate_by_time'> <value name='VALUE'> <block type='number'><field name='NUM'>2</field></block> </value> <value name='ANGLE'> <block type='angle'></block> </value> </block>",
        class: 'rotate',
        isNotFor: [],
        usage: ['direction'],
    },
    rotate_relative: {
        xml:
            "<block type='rotate_relative'> <value name='VALUE'> <block type='angle'></block> </value> </block>",
        class: 'rotate',
        isNotFor: [],
        usage: ['direction'],
    },
    direction_absolute: {
        xml:
            "<block type='direction_absolute'> <value name='VALUE'> <block type='angle'></block> </value> </block>",
        class: 'rotate_absolute',
        isNotFor: [],
        usage: ['direction'],
    },
    direction_relative: {
        xml:
            "<block type='direction_relative'> <value name='VALUE'> <block type='angle'></block> </value> </block>",
        class: 'rotate',
        isNotFor: [],
        usage: ['direction'],
    },
    move_to_angle: {
        xml:
            "<block type='move_to_angle'> <value name='ANGLE'> <block type='angle'></block> </value> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'move_rotate',
        isNotFor: [],
        usage: ['direction'],
    },
    ...
    dialog_time: {
        xml:
            "<block type='dialog_time'> <value name='VALUE'> <block type='text'> <field name='NAME'>" +
            Lang.Blocks.block_hi +
            "</field> </block> </value> <value name='SECOND'> <block type='number'><field name='NUM'>4</field></block> </value> </block>",
        class: 'say',
        isNotFor: ['textBox'],
        usage: ['dialog'],
    },
    dialog: {
        xml:
            "<block type='dialog'> <value name='VALUE'> <block type='text'> <field name='NAME'>" +
            Lang.Blocks.block_hi +
    ...
    change_to_some_shape: {
        xml:
            "<block type='change_to_some_shape'> <value name='VALUE'> <block type='get_pictures'> </block> </value> </block>",
        class: 'shape',
        isNotFor: ['textBox'],
        usage: ['shape'],
    },
    ...
    set_effect_volume: {
        xml:
            "<block type='set_effect_volume'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'effect',
        isNotFor: ['textBox'],
        usage: ['graphic'],
    },
    set_effect_amount: {
        xml:
            "<block type='set_effect_amount'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'effect',
        isNotFor: ['textBox'],
    ...
    set_effect: {
        xml:
            "<block type='set_effect'> <value name='VALUE'> <block type='number'><field name='NUM'>100</field></block> </value> </block>",
        class: 'effect',
        isNotFor: ['textBox'],
        usage: ['graphic'],
    },
    set_entity_effect: {
        xml:
            "<block type='set_entity_effect'> <value name='VALUE'> <block type='number'><field name='NUM'>100</field></block> </value> </block>",
        class: 'effect',
        isNotFor: ['textBox'],
    ...
    add_effect_amount: {
        xml:
            "<block type='add_effect_amount'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'effect',
        isNotFor: ['textBox'],
        usage: ['graphic'],
    },
    change_effect_amount: {
        xml:
            "<block type='change_effect_amount'> <value name='VALUE'> <block type='number'><field name='NUM'>100</field></block> </value> </block>",
        class: 'effect',
        isNotFor: ['textBox'],
        usage: ['graphic'],
    },
    ...
    change_scale_percent: {
        xml:
            "<block type='change_scale_percent'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'scale',
        isNotFor: [],
        usage: ['graphic'],
    },
    set_scale_percent: {
        xml:
            "<block type='set_scale_percent'> <value name='VALUE'> <block type='number'><field name='NUM'>100</field></block> </value> </block>",
        class: 'scale',
        isNotFor: [],
        usage: ['graphic'],
    },
    change_scale_size: {
        xml:
            "<block type='change_scale_size'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'scale',
        isNotFor: [],
        usage: ['graphic'],
    },
    set_scale_size: {
        xml:
            "<block type='set_scale_size'> <value name='VALUE'> <block type='number'><field name='NUM'>100</field></block> </value> </block>",
        class: 'scale',
        isNotFor: [],
        usage: ['graphic'],
    },
    ...
    change_thickness: {
        xml:
            "<block type='change_thickness'> <value name='VALUE'> <block type='number'><field name='NUM'>1</field></block> </value> </block>",
    ...
    set_thickness: {
        xml:
            "<block type='set_thickness'> <value name='VALUE'> <block type='number'><field name='NUM'>1</field></block> </value> </block>",
        class: 'brush_thickness',
        isNotFor: ['textBox'],
        usage: ['brush'],
    },
    change_opacity: {
        xml:
            "<block type='change_opacity'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'brush_opacity',
        isNotFor: ['textBox'],
        usage: ['brush'],
    },
    change_brush_transparency: {
        xml:
            "<block type='change_brush_transparency'> <value name='VALUE'><block type='number'><field name='NUM'>10</field></block> </value></block>",
        class: 'brush_opacity',
        isNotFor: ['textBox'],
        usage: ['brush'],
    },
    set_opacity: {
        xml:
            "<block type='set_opacity'> <value name='VALUE'> <block type='number'><field name='NUM'>50</field></block> </value> </block>",
        class: 'brush_opacity',
        isNotFor: ['textBox'],
        usage: ['brush'],
    },
    set_brush_tranparency: {
        xml:
            "<block type='set_brush_tranparency'> <value name='VALUE'> <block type='number'><field name='NUM'>50</field></block> </value> </block>",
        class: 'brush_opacity',
        isNotFor: ['textBox'],
        usage: ['brush'],
    },
    ...
    sound_something_with_block: {
        xml:
            "<block type='sound_something_with_block'><value name='VALUE'><block type='get_sounds'></block></value></block>",
        class: 'sound_play',
        isNotFor: [],
        description:
    ...
    sound_something_second_with_block: {
        xml:
            "<block type='sound_something_second_with_block'><value name='VALUE'><block type='get_sounds'></block></value><value name='SECOND'><block type='number'><field name='NUM'>1</field></block></value></block>",
        class: 'sound_play',
        isNotFor: [],
        usage: ['sound'],
    },
    sound_something_wait_with_block: {
        xml:
            "<block type='sound_something_wait_with_block'><value name='VALUE'><block type='get_sounds'></block></value></block>",
        class: 'sound_wait',
        isNotFor: [],
        usage: ['sound'],
    },
    sound_something_second_wait_with_block: {
        xml:
            "<block type='sound_something_second_wait_with_block'><value name='VALUE'><block type='get_sounds'></block></value><value name='SECOND'><block type='number'><field name='NUM'>1</field></block></value></block>",
        class: 'sound_wait',
        isNotFor: [],
        usage: ['sound'],
    },
    sound_volume_change: {
        xml:
            "<block type='sound_volume_change'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'sound_volume',
        isNotFor: [],
        usage: ['sound'],
    },
    sound_volume_set: {
        xml:
            "<block type='sound_volume_set'> <value name='VALUE'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'sound_volume',
        isNotFor: [],
        usage: ['sound'],
    },
    ...
    is_included_in_list: {
        xml:
            "<block type='is_included_in_list'> <value name='DATA'> <block type='text'> <field name='NAME'>10</field> </block> </value> </block>",
        class: 'list',
    ...
    boolean_basic_operator: {
        xml:
            "<block type='boolean_basic_operator'> <value name='LEFTHAND'> <block type='text'><field name='NAME'>10</field></block> </value><field name='OPERATOR'>EQUAL</field>  <value name='RIGHTHAND'> <block type='text'><field name='NAME'>10</field></block> </value> </block>",
        xmls: [
    ...
    boolean_and: {
        xml:
            "<block type='boolean_and'> <value name='LEFTHAND'> <block type='True'></block> </value> <value name='RIGHTHAND'> <block type='True'></block> </value> </block>",
        class: 'boolean',
        isNotFor: [],
    ...
    boolean_or: {
        xml:
            "<block type='boolean_or'> <value name='LEFTHAND'> <block type='True'></block> </value> <value name='RIGHTHAND'> <block type='False'></block> </value> </block>",
        class: 'boolean',
        isNotFor: [],
        usage: ['compute_logical'],
    },
    boolean_not: {
        xml:
            "<block type='boolean_not'> <value name='VALUE'> <block type='True'></block> </value> </block>",
        class: 'boolean',
        isNotFor: [],
        usage: ['compute_logical'],
    },
    ...
    calc_rand: {
        xml:
            "<block type='calc_rand'> <value name='LEFTHAND'> <block type='number'><field name='NUM'>0</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'calc',
        isNotFor: [],
        usage: ['calc'],
    },
    ...
    coordinate_object: {
        ...
        isNotFor: [],
        description:
            '선택한 오브젝트의 x,y좌표 및 각종 정보(방향, 모양이름 등)를 의미합니다.',
    },
    ...
    calc_share: {
        xml:
            "<block type='calc_share'> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'calc',
        isNotFor: [],
        usage: ['calculation'],
    },
    calc_mod: {
        xml:
            "<block type='calc_mod'> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> <value name='RIGHTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'calc',
        isNotFor: [],
        usage: ['calculation'],
    },
    calc_operation: {
        xml:
            "<block type='calc_operation'> <value name='LEFTHAND'> <block type='number'><field name='NUM'>10</field></block> </value> </block>",
        class: 'calc',
        isNotFor: [],
        usage: ['calculation'],
    },
    get_date: {
        xml:
            "<block type='get_date'> <field name='VALUE'>YEAR</field> </block>",
        class: 'calc_date',
        isNotFor: [],
        description:
            '현재 연도, 월, 일, 시각과 같이 시간에 대한 값을 의미합니다.',
    },
    distance_something: {
    ...
    set_visible_project_timer: {
        xml:
            "<block type='set_visible_project_timer'><field name='ACTION'>HIDE</field></block>",
        class: 'calc_timer',
        isNotFor: [],
        usage: ['timer'],
    },
    variableAddButton: {
        xml:
            '<btn text="Lang.Workspace.create_variable_block" onclick="Entry.variableContainer.openVariableAddPanel(\'variable\')"> </btn>',
        isNotFor: [],
        class: 'button',
    },
    listAddButton: {
        xml:
            '<btn text="Lang.Workspace.create_list_block" onclick="Entry.variableContainer.openVariableAddPanel(\'list\')"></btn>',
        isNotFor: [],
        class: 'button',
    },
    ask_and_wait: {
        xml:
            "<block type='ask_and_wait'> <value name='VALUE'> <block type='text'> <field name='NAME'>" +
            Lang.Blocks.block_hi +
            '</field> </block> </value> </block>',
        class: 'ask',
        isNotFor: [],
    ...
    combine_something: {
        xml:
            "<block type='combine_something'> <value name='VALUE1'> <block type='text'> <field name='NAME'>" +
            Lang.Blocks.block_hi +
            "</field> </block> </value> <value name='VALUE2'> <block type='text'> <field name='NAME'>" +
            Lang.Blocks.entry +
            '</field> </block> </value> </block>',
        class: 'calc_string',
        isNotFor: [],
    ...
    change_variable: {
        xml:
            "<block type='change_variable'> <value name='VALUE'> <block type='text'> <field name='NAME'>10</field> </block> </value> </block>",
        class: 'variable',
        isNotFor: ['variable', 'variableNotExist'],
        usage: ['variable'],
    },
    set_variable: {
        xml:
            "<block type='set_variable'> <value name='VALUE'> <block type='text'> <field name='NAME'>10</field> </block> </value> </block>",
        class: 'variable',
        isNotFor: ['variable', 'variableNotExist'],
        usage: ['variable'],
    },
    ...
    value_of_index_from_list: {
        xml:
            "<block type='value_of_index_from_list'> <value name='INDEX'> <block type='number'><field name='NUM'>1</field></block> </value> </block>",
        class: 'list_element',
        isNotFor: ['list', 'listNotExist'],
        usage: ['list'],
    },
    add_value_to_list: {
        xml:
            "<block type='add_value_to_list'> <value name='VALUE'> <block type='text'> <field name='NAME'>10</field> </block> </value> </block>",
        class: 'list',
        isNotFor: ['list', 'listNotExist'],
        usage: ['list'],
    },
    remove_value_from_list: {
        xml:
            "<block type='remove_value_from_list'> <value name='VALUE'> <block type='number'><field name='NUM'>1</field></block> </value> </block>",
        class: 'list',
        isNotFor: ['list', 'listNotExist'],
        usage: ['list'],
    },
    insert_value_to_list: {
        xml:
            "<block type='insert_value_to_list'> <value name='DATA'> <block type='text'> <field name='NAME'>10</field> </block> </value> <value name='INDEX'> <block type='text'><field name='NAME'>1</field></block> </value> </block>",
        class: 'list',
        isNotFor: ['list', 'listNotExist'],
        usage: ['list'],
    },
    change_value_list_index: {
        xml:
            "<block type='change_value_list_index'> <value name='INDEX'> <block type='text'><field name='NAME'>1</field></block> </value> <value name='DATA'> <block type='text'> <field name='NAME'>10</field> </block> </value> </block>",
        class: 'list',
        isNotFor: ['list', 'listNotExist'],
        usage: ['list'],
    },
    ...
    text_write: {
        xml:
            "<block type='text_write'><value name='VALUE'><block type='text'></block></value></block>",
        class: 'text',
        isNotFor: ['sprite'],
        usage: ['textbox'],
    },
    text_append: {
        xml:
            "<block type='text_append'><value name='VALUE'><block type='text'></block></value></block>",
        class: 'text',
        isNotFor: ['sprite'],
        usage: ['textbox'],
    },
    text_prepend: {
        xml:
            "<block type='text_prepend'><value name='VALUE'><block type='text'></block></value></block>",
        class: 'text',
        isNotFor: ['sprite'],
        usage: ['textbox'],
    },
    ...
    arduino_download_connector: {
        xml:
            '<btn text="Lang.Blocks.ARDUINO_download_connector" onclick="Entry.hw.downloadConnector()"></btn>',
    ...
    download_guide: {
        xml:
            '<btn text="Lang.Blocks.download_guide" onclick="Entry.hw.downloadGuide()"></btn>',
        isNotFor: ['arduinoDisconnected'],
        usage: ['arduino'],
        class: 'button',
    },
    arduino_download_source: {
        xml:
            '<btn text="Lang.Blocks.ARDUINO_download_source" onclick="Entry.hw.downloadSource()"></btn>',
        isNotFor: ['arduinoDisconnected'],
        usage: ['arduino'],
        class: 'button',
    },
    arduino_reconnect: {
        xml:
            '<btn text="Lang.Blocks.ARDUINO_reconnect" onclick="Entry.hw.retryConnect()"></btn>',
        isNotFor: ['arduinoDisconnected'],
        usage: ['arduino'],
        class: 'button',
    },
    ...
    arduino_get_number_sensor_value: {
        xml:
            "<block type='arduino_get_number_sensor_value'><value name='VALUE'><block type='arduino_get_sensor_number'></block></value></block>",
        isNotFor: ['arduino'],
        usage: ['arduino'],
        class: 'arduino_value',
    },
    ...
    CODEino_get_number_sensor_value: {
        xml:
            "<block type='arduino_get_number_sensor_value'><value name='VALUE'><block type='CODEino_get_sensor_number'></block></value></block>",
        isNotFor: ['CODEino'],
        usage: ['arduino'],
        class: 'arduino_value',
    },
    arduino_get_digital_value: {
        xml:
            "<block type='arduino_get_digital_value'><value name='VALUE'><block type='arduino_get_port_number'></block></value></block>",
        isNotFor: ['arduino'],
        usage: ['arduino'],
        class: 'arduino_value',
    },
    ...
    arduino_toggle_led: {
        xml:
            "<block type='arduino_toggle_led'><value name='VALUE'><block type='arduino_get_port_number'></block></value></block>",
        isNotFor: ['arduino'],
        usage: ['arduino'],
        class: 'arduino_set',
    },
    ...
    arduino_toggle_pwm: {
        xml:
            "<block type='arduino_toggle_pwm'><value name='PORT'><block type='arduino_get_pwm_port_number'></block></value><value name='VALUE'><block type='arduino_text'><field name='NAME'>255</field></block></value></block>",
        isNotFor: ['arduino'],
        usage: ['arduino'],
        class: 'arduino_set',
    },
    ...
    arduino_convert_scale: {
        xml:
            "<block type='arduino_convert_scale'><value name='VALUE1'><block type='arduino_get_number_sensor_value'><value name='VALUE'><block type='arduino_get_sensor_number'></block></value></block></value><value name='VALUE2'> <block type='number'><field name='NUM'>0</field></block> </value><value name='VALUE3'> <block type='number'><field name='NUM'>1023</field></block> </value><value name='VALUE4'> <block type='number'><field name='NUM'>0</field></block> </value><value name='VALUE5'> <block type='number'><field name='NUM'>100</field></block> </value></block>",
        isNotFor: ['arduino'],
        usage: ['arduino'],
        class: 'arduino',
    },
    ...
    CODEino_convert_scale: {
        xml:
            "<block type='arduino_convert_scale'><value name='VALUE1'><block type='arduino_get_number_sensor_value'><value name='VALUE'><block type='CODEino_get_sensor_number'></block></value></block></value><value name='VALUE2'> <block type='number'><field name='NUM'>0</field></block> </value><value name='VALUE3'> <block type='number'><field name='NUM'>1023</field></block> </value><value name='VALUE4'> <block type='number'><field name='NUM'>0</field></block> </value><value name='VALUE5'> <block type='number'><field name='NUM'>100</field></block> </value></block>",
        isNotFor: ['CODEino'],
        usage: ['arduino'],
        class: 'arduino',
    },
    ...
    rotate_by_angle: {
        isNotFor: [],
        xml:
            '<block type=\'rotate_by_angle\'><value name="VALUE"><block type="number"><field name="NUM">90</field></block></value></block>',
        class: 'rotate',
    },
    rotate_by_angle_time: {
        isNotFor: [],
        xml:
            '<block type=\'rotate_by_angle_time\'><value name="VALUE"><block type="number"><field name="NUM">2</field></block></value></block>',
        class: 'rotate',
    },
    rotate_direction: {
        isNotFor: [],
        xml:
            '<block type=\'rotate_direction\'><value name="VALUE"><block type="number"><field name="NUM">90</field></block></value></block>',
        class: 'rotate',
    },
    see_angle_direction: {
        isNotFor: [],
        xml:
            '<block type=\'see_angle_direction\'><value name="VALUE"><block type="number"><field name="NUM">90</field></block></value></block>',
        class: 'rotate',
    },
    see_angle: {
        isNotFor: [],
        xml:
            '<block type=\'see_angle\'><value name="VALUE"><block type="number"><field name="NUM">90</field></block></value></block>',
        class: 'rotate',
    },
    sound_something: {
        isNotFor: [],
    ...
    sound_something_second_wait: {
        isNotFor: [],
        xml:
            '<block type="sound_something_second_wait"><value name="SECOND"><block type="number"><field name="NUM">1</field></block></value></block>',
        class: 'sound',
    },
    sound_something_second: {
        isNotFor: [],
        xml:
            '<block type="sound_something_second"><value name="SECOND"><block type="number"><field name="NUM">1</field></block></value></block>',
        class: 'sound',
    },
    boolean_equal: {
        isNotFor: [],
        xml:
            '<block type="boolean_equal"><value name="LEFTHAND"><block type="number"><field name="NUM">10</field></block></value><value name="RIGHTHAND"><block type="number"><field name="NUM">10</field></block></value></block>',
        class: 'boolean_compare',
    },
    boolean_bigger: {
        isNotFor: [],
        xml:
            '<block type="boolean_bigger"><value name="LEFTHAND"><block type="number"><field name="NUM">10</field></block></value><value name="RIGHTHAND"><block type="number"><field name="NUM">10</field></block></value></block>',
        class: 'boolean_compare',
    },
    boolean_smaller: {
        isNotFor: [],
        xml:
            '<block type="boolean_smaller"><value name="LEFTHAND"><block type="number"><field name="NUM">10</field></block></value><value name="RIGHTHAND"><block type="number"><field name="NUM">10</field></block></value></block>',
        class: 'boolean_compare',
    },
    change_to_nth_shape: {
        isNotFor: [],
    ...
    ebs_if: {
        isNotFor: [],
        xml:
            "<block type='_if'><value name='BOOL'><block type='reach_something'><field name='VALUE'>wall</field></block></value></block>",
        class: 'condition',
    },
    ebs_if2: {
        isNotFor: [],
        xml:
            "<block type='_if'><value name='BOOL'><block type='reach_something'><field name='VALUE'>cwz5</field></block></value></block>",
        class: 'condition',
    },
    char_at: {
        xml:
            "<block type='char_at'><value name='LEFTHAND'><block type='text'><field name='NAME'>" +
            Lang.Blocks.hi_entry +
            "</field></block></value><value name='RIGHTHAND'><block type='number'><field name='NUM'>1</field></block></value></block>",
        class: 'calc_string',
        isNotFor: [],
        usage: [],
    },
    length_of_string: {
        xml:
            "<block type='length_of_string'><value name='STRING'><block type='text'><field name='NAME'>" +
            Lang.Blocks.entry +
            '</field></block></value></block>',
        class: 'calc_string',
        isNotFor: [],
    ...
    substring: {
        xml:
            "<block type='substring'><value name='STRING'><block type='text'><field name='NAME'>" +
            Lang.Blocks.hi_entry +
            "</field></block></value><value name='START'><block type='number'><field name='NUM'>2</field></block></value><value name='END'><block type='number'><field name='NUM'>5</field></block></value></block>",
        class: 'calc_string',
        isNotFor: [],
        usage: [],
    },
    replace_string: {
        xml:
            "<block type='replace_string'><value name='STRING'><block type='text'><field name='NAME'>" +
            Lang.Blocks.hi_entry +
            "</field></block></value><value name='OLD_WORD'><block type='text'><field name='NAME'>" +
            Lang.Blocks.hello +
            "</field></block></value><value name='NEW_WORD'><block type='text'><field name='NAME'>" +
            Lang.Blocks.nice +
            '</field></block></value></block>',
        class: 'calc_string',
        isNotFor: [],
    ...
    change_string_case: {
        xml:
            "<block type='change_string_case'><value name='STRING'><block type='text'><field name='NAME'>" +
            Lang.Blocks.hi_entry_en +
            '</field></block></value></block>',
        class: 'calc_string',
        isNotFor: [],
        usage: [],
    ...
    index_of_string: {
        xml:
            "<block type='index_of_string'><value name='LEFTHAND'><block type='text'><field name='NAME'>" +
            Lang.Blocks.hi_entry +
            "</field></block></value><value name='RIGHTHAND'><block type='text'><field name='NAME'>" +
            Lang.Blocks.entry +
            '</field></block></value></block>',
        class: 'calc_string',
        isNotFor: [],
    ...
    neobot_left_motor: {
        isNotFor: ['neobot'],
        xml:
            "<block type='neobot_left_motor'><field name='SPEED'>15</field></block>",
        class: 'neobot_motor',
    },
    neobot_stop_left_motor: {
        isNotFor: ['neobot'],
    ...
    neobot_right_motor: {
        isNotFor: ['neobot'],
        xml:
            "<block type='neobot_right_motor'><field name='SPEED'>15</field></block>",
        class: 'neobot_motor',
    },
    neobot_stop_right_motor: {
        isNotFor: ['neobot'],
    ...
    neobot_all_motor: {
        isNotFor: ['neobot'],
        xml:
            "<block type='neobot_all_motor'><field name='SPEED'>15</field></block>",
        class: 'neobot_motor',
    },
    neobot_set_servo: {
        isNotFor: ['neobot'],
    ...
    neobot_set_output: {
        isNotFor: ['neobot'],
        xml:
            "<block type='neobot_set_output'><value name='VALUE'><block type='number'><field name='NUM'>255</field></block></value></block>",
        class: 'neobot_output',
    },
    neobot_set_fnd: {
        isNotFor: ['neobot'],
        xml:
            "<block type='neobot_set_fnd'><value name='VALUE'><block type='number'><field name='NUM'>0</field></block></value></block>",
        class: 'neobot_output',
    },
    neobot_play_note_for: {
        isNotFor: ['neobot'],
        xml:
            "<block type='neobot_play_note_for'><field name='NOTE'>1</field><field name='OCTAVE'>2</field><field name='DURATION'>4</field></block>",
        class: 'neobot_note',
    },
    bitbrick_sensor_value: {
        isNotFor: ['bitbrick'],
    ...
    bitbrick_turn_on_color_led_by_rgb: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_turn_on_color_led_by_rgb'><value name='rValue'><block type='text'><field name='NAME'>255</field></block></value><value name='gValue'><block type='text'><field name='NAME'>255</field></block></value><value name='bValue'><block type='text'><field name='NAME'>255</field></block></value></block>",
        class: 'condition',
    },
    bitbrick_turn_on_color_led_by_picker: {
        isNotFor: ['bitbrick'],
    ...
    bitbrick_turn_on_color_led_by_value: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_turn_on_color_led_by_value'><value name='VALUE'><block type='text'><field name='NAME'>0</field></block></value></block>",
        class: 'condition',
    },
    bitbrick_buzzer: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_buzzer'><value name='VALUE'><block type='text'><field name='NAME'>60</field></block></value></block>",
        class: 'condition',
    },
    bitbrick_turn_off_all_motors: {
        isNotFor: ['bitbrick'],
    ...
    bitbrick_dc_speed: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_dc_speed'><value name='VALUE'><block type='text'><field name='NAME'>60</field></block></value></block>",
        class: 'condition',
    },
    bitbrick_dc_direction_speed: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_dc_direction_speed'><value name='VALUE'><block type='text'><field name='NAME'>100</field></block></value></block>",
        class: 'condition',
    },
    bitbrick_servomotor_angle: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_servomotor_angle'><value name='VALUE'><block type='text'><field name='NAME'>100</field></block></value></block>",
        class: 'condition',
    },
    bitbrick_convert_scale: {
        isNotFor: ['bitbrick'],
        xml:
            "<block type='bitbrick_convert_scale'><value name='VALUE2'> <block type='number'><field name='NUM'>0</field></block> </value><value name='VALUE3'> <block type='number'><field name='NUM'>1023</field></block> </value><value name='VALUE4'> <block type='number'><field name='NUM'>-100</field></block> </value><value name='VALUE5'> <block type='number'><field name='NUM'>100</field></block> </value></block>",
        class: 'condition',
    },
    hamster_hand_found: {
        isNotFor: ['hamster'],
    ...
    hamster_move_forward_for_secs: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_move_forward_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_move_backward_for_secs: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_move_backward_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_turn_for_secs: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_turn_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_change_both_wheels_by: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_change_both_wheels_by'><value name='LEFT'><block type='text'><field name='NAME'>10</field></block></value><value name='RIGHT'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_set_both_wheels_to: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_set_both_wheels_to'><value name='LEFT'><block type='text'><field name='NAME'>30</field></block></value><value name='RIGHT'><block type='text'><field name='NAME'>30</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_change_wheel_by: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_change_wheel_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_set_wheel_to: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_set_wheel_to'><value name='VALUE'><block type='text'><field name='NAME'>30</field></block></value></block>",
        class: 'hamster_wheel',
    },
    hamster_follow_line_using: {
        isNotFor: ['hamster'],
    ...
    hamster_set_following_speed_to: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_set_following_speed_to'><field name='SPEED'>5</field></block>",
        class: 'hamster_wheel',
    },
    hamster_stop: {
        isNotFor: ['hamster'],
    ...
    hamster_change_buzzer_by: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_change_buzzer_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'hamster_buzzer',
    },
    hamster_set_buzzer_to: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_set_buzzer_to'><value name='VALUE'><block type='text'><field name='NAME'>1000</field></block></value></block>",
        class: 'hamster_buzzer',
    },
    hamster_clear_buzzer: {
        isNotFor: ['hamster'],
    ...
    hamster_play_note_for: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_play_note_for'><field name='OCTAVE'>4</field><value name='VALUE'><block type='text'><field name='NAME'>0.5</field></block></value></block>",
        class: 'hamster_buzzer',
    },
    hamster_rest_for: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_rest_for'><value name='VALUE'><block type='text'><field name='NAME'>0.25</field></block></value></block>",
        class: 'hamster_buzzer',
    },
    hamster_change_tempo_by: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_change_tempo_by'><value name='VALUE'><block type='text'><field name='NAME'>20</field></block></value></block>",
        class: 'hamster_buzzer',
    },
    hamster_set_tempo_to: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_set_tempo_to'><value name='VALUE'><block type='text'><field name='NAME'>60</field></block></value></block>",
        class: 'hamster_buzzer',
    },
    hamster_set_port_to: {
        isNotFor: ['hamster'],
    ...
    hamster_change_output_by: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_change_output_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'hamster_port',
    },
    hamster_set_output_to: {
        isNotFor: ['hamster'],
        xml:
            "<block type='hamster_set_output_to'><value name='VALUE'><block type='text'><field name='NAME'>100</field></block></value></block>",
        class: 'hamster_port',
    },
    ...
    albert_move_forward_for_secs: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_move_forward_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_move_backward_for_secs: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_move_backward_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_turn_for_secs: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_turn_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_change_both_wheels_by: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_change_both_wheels_by'><value name='LEFT'><block type='text'><field name='NAME'>10</field></block></value><value name='RIGHT'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_set_both_wheels_to: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_set_both_wheels_to'><value name='LEFT'><block type='text'><field name='NAME'>30</field></block></value><value name='RIGHT'><block type='text'><field name='NAME'>30</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_change_wheel_by: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_change_wheel_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_set_wheel_to: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_set_wheel_to'><value name='VALUE'><block type='text'><field name='NAME'>30</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_stop: {
        isNotFor: ['albert'],
    ...
    albert_set_pad_size_to: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_set_pad_size_to'><value name='WIDTH'><block type='text'><field name='NAME'>108</field></block></value><value name='HEIGHT'><block type='text'><field name='NAME'>76</field></block></value></block>",
        class: 'albert_wheel',
    },
    albert_set_eye_to: {
        isNotFor: ['albert'],
    ...
    albert_change_buzzer_by: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_change_buzzer_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'albert_buzzer',
    },
    albert_set_buzzer_to: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_set_buzzer_to'><value name='VALUE'><block type='text'><field name='NAME'>1000</field></block></value></block>",
        class: 'albert_buzzer',
    },
    albert_clear_buzzer: {
        isNotFor: ['albert'],
    ...
    albert_play_note_for: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_play_note_for'><field name='OCTAVE'>4</field><value name='VALUE'><block type='text'><field name='NAME'>0.5</field></block></value></block>",
        class: 'albert_buzzer',
    },
    albert_rest_for: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_rest_for'><value name='VALUE'><block type='text'><field name='NAME'>0.25</field></block></value></block>",
        class: 'albert_buzzer',
    },
    albert_change_tempo_by: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_change_tempo_by'><value name='VALUE'><block type='text'><field name='NAME'>20</field></block></value></block>",
        class: 'albert_buzzer',
    },
    albert_set_tempo_to: {
        isNotFor: ['albert'],
        xml:
            "<block type='albert_set_tempo_to'><value name='VALUE'><block type='text'><field name='NAME'>60</field></block></value></block>",
        class: 'albert_buzzer',
    },
    sensorBoard_get_named_sensor_value: {
    ...
    dplay_get_value: {
        xml:
            "<block type='dplay_get_value'><value name='VALUE'><block type='arduino_get_sensor_number'></block></value></block>",
        isNotFor: ['dplay'],
        usage: ['arduino'],
        class: 'dplay_set',
    },
    ...
    dplay_buzzer: {
        xml:
            "<block type='dplay_buzzer'><value name='VALUE'><block type='arduino_text'><field name='NAME'>0</field></block></value></block>",
        isNotFor: ['dplay'],
        usage: ['arduino'],
        class: 'dplay',
    },
    dplay_select_led: {
        xml:
            "<block type='dplay_select_led'><block type='arduino_get_port_number'></block></block>",
        isNotFor: ['dplay'],
        usage: ['arduino'],
        class: 'dplay',
    },
    ...
    dplay_servo: {
        xml:
            "<block type='dplay_servo'><value name='VALUE'><block type='arduino_text'><field name='NAME'>255</field></block></value></block>",
        isNotFor: ['dplay'],
        usage: ['arduino'],
        class: 'dplay',
    },
    direction_relative_duration: {
        isNotFor: [''],
        xml:
            "<block type='direction_relative_duration'><value name='DURATION'><block type='text'><field name='NAME'>2</field></block></value><value name='AMOUNT'><block type='angle'></block></value></block>",
        class: 'rotate',
    },
    get_sound_volume: {
        isNotFor: [''],
    ...
    sound_from_to: {
        isNotFor: [''],
        xml:
            "<block type='sound_from_to'><value name='VALUE'><block type='get_sounds'></block></value><value name='START'><block type='text'><field name='NAME'>1</field></block></value><value name='END'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'sound_play',
    },
    sound_from_to_and_wait: {
        isNotFor: [''],
        xml:
            "<block type='sound_from_to_and_wait'><value name='VALUE'><block type='get_sounds'></block></value><value name='START'><block type='text'><field name='NAME'>1</field></block></value><value name='END'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'sound_wait',
    },
    quotient_and_mod: {
        isNotFor: [''],
        xml:
            "<block type='quotient_and_mod'><value name='LEFTHAND'><block type='text'><field name='NAME'>10</field></block></value><value name='RIGHTHAND'><block type='text'><field name='NAME'>10</field></block></value></block>",
        //"xmls": [
    ...
    set_visible_answer: {
        isNotFor: [''],
        xml:
            "<block type='set_visible_answer'><field name='BOOL'>HIDE</field></block>",
        class: 'ask',
    },
    choose_project_timer_action: {
        isNotFor: [''],
        xml:
            "<block type='choose_project_timer_action'><field name='ACTION'>START</field></block>",
        class: 'calc_timer',
    },
    robotis_openCM70_cm_buzzer_index: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_cm_buzzer_index'><value name='CM_BUZZER_TIME'><block type='number'><field name='NUM'>1</field></block></value></block>",
    ...
    robotis_openCM70_cm_motion: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_cm_motion'><value name='VALUE'><block type='number'><field name='NUM'>1</field></block></value></block>",
        class: 'robotis_openCM70_cm',
    },
    robotis_openCM70_aux_motor_speed: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_aux_motor_speed'><value name='VALUE'><block type='number'><field name='NUM'>500</field></block></value></block>",
        class: 'robotis_openCM70_cm',
    },
    robotis_openCM70_aux_servo_mode: {
        isNotFor: ['robotis_openCM70'],
    ...
    robotis_openCM70_aux_servo_speed: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_aux_servo_speed'><value name='VALUE'><block type='number'><field name='NUM'>500</field></block></value></block>",
        class: 'robotis_openCM70_cm',
    },
    robotis_openCM70_aux_servo_position: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_aux_servo_position'><value name='VALUE'><block type='number'><field name='NUM'>512</field></block></value></block>",
        class: 'robotis_openCM70_cm',
    },
    robotis_openCM70_aux_led_module: {
        isNotFor: ['robotis_openCM70'],
    ...
    robotis_openCM70_aux_custom: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_aux_custom'><value name='VALUE'><block type='number'><field name='NUM'>0</field></block></value></block>",
        class: 'robotis_openCM70_cm',
    },
    robotis_openCM70_cm_custom_value: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_cm_custom_value'><value name='VALUE'><block type='number'><field name='NUM'>0</field></block></value></block>",
        class: 'robotis_openCM70_custom',
    },
    robotis_openCM70_cm_custom: {
        isNotFor: ['robotis_openCM70'],
        xml:
            "<block type='robotis_openCM70_cm_custom'><value name='ADDRESS'><block type='number'><field name='NUM'>0</field></block></value><value name='VALUE'><block type='number'><field name='NUM'>0</field></block></value></block>",
        class: 'robotis_openCM70_custom',
    },
    robotis_carCont_sensor_value: {
    ...
    robotis_carCont_aux_motor_speed: {
        isNotFor: ['robotis_carCont'],
        xml:
            "<block type='robotis_carCont_aux_motor_speed'><value name='VALUE'><block type='number'><field name='NUM'>500</field></block></value></block>",
        class: 'robotis_carCont_cm',
    },
    robotis_carCont_cm_calibration: {
        isNotFor: ['robotis_carCont'],
        xml:
            "<block type='robotis_carCont_cm_calibration'><value name='VALUE'><block type='number'><field name='NUM'>0</field></block></value></block>",
        class: 'robotis_carCont_cm',
    },
    ...
    coconut_move_forward_for_secs: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_move_forward_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'coconut_wheel',
    },
    coconut_move_backward_for_secs: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_move_backward_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'coconut_wheel',
    },
    coconut_turn_for_secs: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_turn_for_secs'><value name='VALUE'><block type='text'><field name='NAME'>1</field></block></value></block>",
        class: 'coconut_wheel',
    },
    coconut_change_both_wheels_by: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_change_both_wheels_by'><value name='LEFT'><block type='text'><field name='NAME'>10</field></block></value><value name='RIGHT'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'coconut_wheel',
    },
    coconut_set_both_wheels_to: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_set_both_wheels_to'><value name='LEFT'><block type='text'><field name='NAME'>30</field></block></value><value name='RIGHT'><block type='text'><field name='NAME'>30</field></block></value></block>",
        class: 'coconut_wheel',
    },
    coconut_change_wheel_by: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_change_wheel_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'coconut_wheel',
    },
    coconut_set_wheel_to: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_set_wheel_to'><value name='VALUE'><block type='text'><field name='NAME'>30</field></block></value></block>",
        class: 'coconut_wheel',
    },
    ...
    coconut_set_following_speed_to: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_set_following_speed_to'><field name='SPEED'>5</field></block>",
        class: 'coconut_wheel',
    },
    coconut_stop: {
        isNotFor: ['coconut'],
    ...
    coconut_change_buzzer_by: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_change_buzzer_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'coconut_buzzer',
    },
    coconut_set_buzzer_to: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_set_buzzer_to'><value name='VALUE'><block type='text'><field name='NAME'>1000</field></block></value></block>",
        class: 'coconut_buzzer',
    },
    coconut_clear_buzzer: {
        isNotFor: ['coconut'],
    ...
    coconut_play_note_for: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_play_note_for'><field name='OCTAVE'>4</field><value name='VALUE'><block type='text'><field name='NAME'>0.5</field></block></value></block>",
        class: 'coconut_buzzer',
    },
    coconut_rest_for: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_rest_for'><value name='VALUE'><block type='text'><field name='NAME'>0.25</field></block></value></block>",
        class: 'coconut_buzzer',
    },
    coconut_change_tempo_by: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_change_tempo_by'><value name='VALUE'><block type='text'><field name='NAME'>20</field></block></value></block>",
        class: 'coconut_buzzer',
    },
    coconut_set_tempo_to: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_set_tempo_to'><value name='VALUE'><block type='text'><field name='NAME'>60</field></block></value></block>",
        class: 'coconut_buzzer',
    },
    coconut_set_port_to: {
        isNotFor: ['coconut'],
    ...
    coconut_change_output_by: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_change_output_by'><value name='VALUE'><block type='text'><field name='NAME'>10</field></block></value></block>",
        class: 'coconut_port',
    },
    coconut_set_output_to: {
        isNotFor: ['coconut'],
        xml:
            "<block type='coconut_set_output_to'><value name='VALUE'><block type='text'><field name='NAME'>100</field></block></value></block>",
        class: 'coconut_port',
    },
};
