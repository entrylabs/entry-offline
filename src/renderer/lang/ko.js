...
Lang.CommandTooltip = {
    ...
    '117': '블록 쓰레드 추가하기',
    '118':
        '블록 연결하기@@이 곳에 블록을 연결합니다.$$이 곳에 블록의 왼쪽 끝을 끼워 넣습니다.',
...
Lang.Menus = {
    ...
    count_ko: '개',
    no_asgn_within_week:
        '1주일안에 제출되어야 하는 마감 임박한 과제가 없습니다.',
    ...
    lecture_save_as_mine_alert:
        "저장되었습니다. 저장된 강의는 '마이페이지> 나의 강의'에서 확인할 수 있습니다.",
    ...
    hw_submit_alert2:
        '과제를 제출하시겠습니까? 제출 시 진행한 학습 단계까지만 제출이 됩니다.',
    ...
    lesson_share_cancel_alert:
        '이(가) 공유된 모든 공간에서 공유를 취소하고 <나만보기>로 변경하시겠습니까? ',
    ...
    cannot_issue_pw:
        '초대를 수락하지 않았으므로 비밀번호를 발급할 수 없습니다.',
    ...
    learning_process_by_grades_sub1:
        '프로그래밍의 원리를 학습단계에 맞게 배울 수 있는 엔트리 강의 모음! 지금 시작해보세요!',
    learning_process_by_grades_sub2:
        '아래 4가지 유형에 따라 만들다 보면 어렵게 느껴졌던 프로그래밍의 원리도 쉽고 재미있게 다가옵니다!',
    e3_to_e4: '초등 3-4학년',
    e5_to_e6: '초등 5-6학년',
    m1_to_m3: '중등 이상',
    ...
    no_lecture_collect_2:
        "'오픈 강의 모음 만들기'에서 강의 모음을 만들어보세요!",
    ...
    entry_go_go: '엔트리 고고!',
    entry_go_go_desc:
        '학년별, 난이도 별로 준비된 교재를 만나보세요. 각 과정별로 교육과정, 교재, 교사용 지도자료 3종 세트가 제공됩니다.',
    stage_beginner: '초급',
    stage_middle: '중급',
    stage_high: '고급',
    ...
    entryLearnDesc_2:
        '<학습하기>에서는 컴퓨터를 활용해 논리적으로 문제를 해결할 수 있는 다양한 학습',
    entryLearnDesc_3:
        '콘텐츠가 준비되어 있습니다. 게임을 하듯이 재미있게 주어진 미션들을 프로그래밍으로',
    entryLearnDesc_4:
        '해결해볼 수 있고 유익한 동영상을 통해 소프트웨어의 원리를 배울 수 있습니다.',
    entryMakeDesc_1:
    ...
    footer_description_1:
        '엔트리는 비영리 교육 플랫폼으로써, 모든 엔트리의 저작물은 교육적 목적에 한하여 출처를 밝히고 자유롭게 이용할 수 있습니다.',
    ...
    offline_required_detail:
        '디스크 여유 공간 500MB 이상, windows7 혹은 MAC OS 10.8 이상',
    ...
    maze_content_13:
        '여기저기 도움이 필요한 친구들이 많이 있네! 모두 도와주자!',
    maze_content_14:
    ...
    maze_fail_not_found_destory_monster:
        '몬스터가 없는 곳에 공격을 하면 안 돼!',
    ...
    maple_success_final_perfect_henesys:
        '멋져! 헤네시스 모험을 훌륭하게 해냈어.',
...
Lang.Msgs = {
    ...
    error_forbidden:
        "저장할 수 있는 권한이 없습니다. 만약 같은 문제가 다시 발생 하면 '제안 및 건의' 게시판에 문의 바랍니다. ",
    ...
    ie_page_desc:
        '엔트리는 인터넷 익스플로어 10 버전 이상 또는 크롬 브라우저에서 이용하실 수 있습니다.<br/>윈도우 업데이트를 진행하시거나, 크롬 브라우저를 설치해주세요.<br/>엔트리 오프라인 버전은 인터넷이 연결되어 있지 않아도 사용할 수 있습니다. 지금 다운받아서 시작해보세요!',
...
Lang.Users = {
    ...
    password_long:
        '암호는 4~20자 사이의 영문자와 숫자, 특수문자로 입력해 주세요',
...
Lang.Workspace = {
    ...
    Variable_used_at_special_object:
        '특정 오브젝트에서만 사용되는 변수 입니다. ',
    draw_new: '새로 그리기',
    draw_new_ebs: '직접 그리기',
    painter_file: '파일 ▼',
    ...
    variable_name_auto_edited_content:
        '변수의 이름은 10글자를 넘을 수 없습니다.',
...
Lang.Helper = {
    ...
    stop_object:
        '모든 : 모든 오브젝트들이 즉시 실행을 멈춥니다. <br> 자신 : 해당 오브젝트의 모든 블록들을 멈춥니다. <br> 이 코드 : 이 블록이 포함된 코드가 즉시 실행을 멈춥니다.  <br> 자신의 다른 코드 :  해당 오브젝트 중 이 블록이 포함된 코드를 제외한 모든 코드가 즉시 실행을 멈춥니다.',
    ...
    move_direction:
        '설정한 값만큼 오브젝트의 이동방향 화살표가 가리키는 방향으로 움직입니다.',
    move_x: '오브젝트의 X좌표를 설정한 값만큼 바꿉니다. ',
    move_y: '오브젝트의 Y좌표를 설정한 값만큼 바꿉니다.',
    move_xy_time:
        '오브젝트가 입력한 시간에 걸쳐 x와 y좌표를 설정한 값만큼 바꿉니다',
    locate_object_time:
        '오브젝트가 입력한 시간에 걸쳐 선택한 오브젝트 또는 마우스 포인터의 위치로 이동합니다. (오브젝트의 중심점이 기준이 됩니다.)',
    locate_x:
        '오브젝트가 입력한 x좌표로 이동합니다. (오브젝트의 중심점이 기준이 됩니다.)',
    locate_y:
        '오브젝트가 입력한 y좌표로 이동합니다. (오브젝트의 중심점이 기준이 됩니다.)',
    locate_xy:
        '오브젝트가 입력한 x와 y좌표로 이동합니다. (오브젝트의 중심점이 기준이 됩니다.)',
    locate_xy_time:
        '오브젝트가 입력한 시간에 걸쳐 지정한 x, y좌표로 이동합니다. (오브젝트의 중심점이 기준이 됩니다.)',
    locate:
        '오브젝트가 선택한 오브젝트 또는 마우스 포인터의 위치로 이동합니다. (오브젝트의 중심점이 기준이 됩니다.)',
    rotate_absolute: '해당 오브젝트의 방향을 입력한 각도로 정합니다.',
    rotate_by_time:
        '오브젝트의 방향을 입력한 시간에 걸쳐 입력한 각도만큼 시계방향으로 회전합니다. (오브젝트의 중심점을 기준으로 회전합니다.)',
    rotate_relative:
    ...
    move_to_angle:
        '설정한 각도 방향으로 입력한 값만큼 움직입니다. (실행화면 위쪽이 0도, 시계방향으로 갈수록 각도 증가)',
    see_angle_object:
        '해당 오브젝트가 다른 오브젝트 또는 마우스 포인터 쪽을 바라봅니다. 오브젝트의 이동방향이 선택된 항목을 향하도록 오브젝트의 방향을 회전해줍니다.',
    ...
    change_to_some_shape:
        '오브젝트를 선택한 모양으로 바꿉니다. (내부 블록을 분리하면 모양의 번호를 사용하여 모양 선택 가능)',
    change_to_next_shape: '오브젝트의 모양을 다음 모양으로 바꿉니다.',
    set_effect_volume: '해당 오브젝트에 선택한 효과를 입력한 값만큼 줍니다.',
    set_effect_amount:
        '색깔 : 오브젝트에 색깔 효과를 입력한 값만큼 줍니다. (0~100을 주기로 반복됨)<br>밝기 : 오브젝트에 밝기 효과를 입력한 값만큼 줍니다. (-100~100 사이의 범위, -100 이하는 -100으로 100 이상은 100으로 처리 됨) <br> 투명도 : 오브젝트에 투명도 효과를 입력한 값만큼 줍니다. (0~100 사이의 범위, 0이하는 0으로, 100 이상은 100으로 처리됨)',
    ...
    change_effect_amount:
        '색깔 : 오브젝트의 색깔 효과를 입력한 값으로 정합니다. (0~100을 주기로 반복됨) <br> 밝기 : 오브젝트의 밝기 효과를 입력한 값으로 정합니다. (-100~100 사이의 범위, -100 이하는 -100으로 100 이상은 100으로 처리 됨) <br> 투명도 : 오브젝트의 투명도 효과를 입력한 값으로 정합니다. (0~100 사이의 범위, 0이하는 0으로, 100 이상은 100으로 처리됨)',
    ...
    change_object_index:
        '맨 앞으로 : 해당 오브젝트를 화면의 가장 앞쪽으로 가져옵니다. <br> 앞으로 : 해당 오브젝트를 한 층 앞쪽으로 가져옵니다. <br> 뒤로 : 해당 오브젝트를 한 층 뒤쪽으로 보냅니다. <br> 맨 뒤로 : 해당 오브젝트를 화면의 가장 뒤쪽으로 보냅니다.',
    ...
    change_thickness:
        '오브젝트가 그리는 선의 굵기를 입력한 값만큼 바꿉니다. (1~무한의 범위, 1 이하는 1로 처리)',
    set_thickness:
        '오브젝트가 그리는 선의 굵기를 입력한 값으로 정합니다. (1~무한의 범위, 1 이하는 1로 처리)',
    change_opacity:
        '해당 오브젝트가 그리는 붓의 투명도를 입력한 값만큼 바꿉니다.',
    change_brush_transparency:
        '해당 오브젝트가 그리는 붓의 투명도를 입력한 값만큼 바꿉니다. (0~100의 범위, 0이하는 0, 100 이상은 100으로 처리)',
    set_opacity: '해당 오브젝트가 그리는 붓의 투명도를 입력한 값으로 정합니다.',
    set_brush_tranparency:
        '해당 오브젝트가 그리는 붓의 투명도를 입력한 값으로 정합니다. (0~100의 범위, 0이하는 0, 100 이상은 100으로 처리)',
    brush_erase_all: '해당 오브젝트가 그린 선과 도장을 모두 지웁니다.',
    sound_something_with_block:
        '해당 오브젝트가 선택한 소리를 재생하는 동시에 다음 블록을 실행합니다.',
    sound_something_second_with_block:
        '해당 오브젝트가 선택한 소리를 입력한 시간 만큼만 재생하는 동시에 다음 블록을 실행합니다.',
    sound_something_wait_with_block:
        '해당 오브젝트가 선택한 소리를 재생하고, 소리 재생이 끝나면 다음 블록을 실행합니다.',
    sound_something_second_wait_with_block:
        '해당 오브젝트가 선택한 소리를 입력한 시간 만큼만 재생하고, 소리 재생이 끝나면 다음 블록을 실행합니다.',
    sound_volume_change:
    ...
    boolean_basic_operator:
        "= : 왼쪽에 위치한 값과 오른쪽에 위치한 값이  같으면 '참'으로 판단합니다.<br>> : 왼쪽에 위치한 값이 오른쪽에 위치한 값보다 크면 '참'으로 판단합니다.<br>< : 왼쪽에 위치한 값이 오른쪽에 위치한 값보다 작으면 '참'으로 판단합니다.<br>≥ : 왼쪽에 위치한 값이 오른쪽에 위치한 값보다 크거나 같으면 '참'으로 판단합니다.<br>≤ : 왼쪽에 위치한 값이 오른쪽에 위치한 값보다 작거나 같으면 '참'으로 판단합니다.",
    function_create:
    ...
    function_field_string:
        '해당 함수를 실행하는데 문자/숫자 값이 필요한 경우 빈칸 안에 조립하여 매개변수로 사용합니다. 이 블록 내부의[문자/숫자값]을 분리하여 함수의 코드 중 필요한 부분에 넣어 사용합니다.',
    function_field_boolean:
        '해당 함수를 실행하는 데 참 또는 거짓의 판단이 필요한 경우 빈칸 안에 조립하여 매개변수로 사용합니다. 이 블록 내부의 [판단값]을 분리하여 함수의 코드 중 필요한 부분에 넣어 사용합니다.',
    function_general:
    ...
    calc_basic:
        '+ : 입력한 두 수를 더한 값입니다.<br>- : 입력한 두 수를 뺀 값입니다.<br>X : 입력한 두 수를 곱한 값입니다.<br>/ : 입력한 두 수를 나눈 값입니다.',
    calc_rand:
    ...
    coordinate_object:
        '선택한 오브젝트 또는 자신의 각종 정보값(x좌표, y좌표, 방향, 이동방향, 크기, 모양번호, 모양이름)입니다.',
    quotient_and_mod:
        '몫 : 앞의 수에서 뒤의 수를 나누어 생긴 몫의 값입니다. <br> 나머지 : 앞의 수에서 뒤의 수를 나누어 생긴 나머지 값입니다.',
    ...
    choose_project_timer_action:
        '시작하기: 초시계를 시작합니다. <br> 정지하기: 초시계를 정지합니다. <br> 초기화하기: 초시계의 값을 0으로 초기화합니다. <br> (이 블록을 블록조립소로 가져오면 실행화면에 ‘초시계 창’이 생성됩니다.)',
    reset_project_timer: '실행되고 있던 타이머를 0으로 초기화합니다.',
    set_visible_project_timer: '초시계 창을 화면에서 숨기거나 보이게 합니다.',
    ask_and_wait:
        '해당 오브젝트가 입력한 문자를 말풍선으로 묻고, 대답을 입력받습니다. (이 블록을 블록조립소로 가져오면 실행화면에 ‘대답 창’이 생성됩니다.)',
    get_canvas_input_value: '묻고 기다리기에 의해 입력된 값입니다.',
    set_visible_answer:
        '실행화면에 있는 ‘대답 창’을 보이게 하거나 숨길 수 있습니다.',
    ...
    value_of_index_from_list:
        '선택한 리스트에서 선택한 값의 순서에 있는 항목 값을 의미합니다. (내부 블록을 분리하면 순서를 숫자로 입력 가능)',
    add_value_to_list:
        '입력한 값이 선택한 리스트의 마지막 항목으로 추가됩니다.',
    remove_value_from_list:
        '선택한 리스트의 입력한 순서에 있는 항목을 삭제합니다.',
    insert_value_to_list:
        '선택한 리스트의 입력한 순서의 위치에 입력한 항목을 넣습니다. (입력한 항목의 뒤에 있는 항목들은 순서가 하나씩 밀려납니다.)',
    ...
    replace_string:
        '입력한 문자/숫자 값에서 지정한 문자/숫자 값을 찾아 추가로 입력한 문자/숫자값으로 모두 바꾼 값입니다. (영문 입력시 대소문자를 구분합니다.)',
    index_of_string:
        '입력한 문자/숫자 값에서 지정한 문자/숫자 값이 처음으로 등장하는 위치의 값입니다. (안녕, 엔트리!에서 엔트리의 시작 위치는 5)',
    change_string_case:
        '입력한 영문의 모든 알파벳을 대문자 또는 소문자로 바꾼 문자값을 의미합니다.',
    direction_relative_duration:
        '해당 오브젝트의 이동방향을 입력한 시간에 걸쳐 입력한 각도만큼 시계방향으로 회전합니다. ',
    ...
    byrobot_dronefighter_controller_controller_value_button:
        "<br>조종기에서 눌러진 버튼과 관련된 이벤트를 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#버튼</font>",
    byrobot_dronefighter_controller_controller_value_joystick:
        "<br>조종기의 조이스틱과 관련된 입력 값을 반환합니다. 각 축의 범위는 -100 ~ 100 입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    byrobot_dronefighter_controller_controller_if_button_press:
        "<br>지정한 조종기의 버튼이 눌러졌을 때 true를 반환합니다.<br><br><font color='crimson'>#조건</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#버튼</font>",
    byrobot_dronefighter_controller_controller_if_joystick_direction:
        "<br>조종기의 조이스틱을 지정한 방향으로 움직였을 때 true를 반환합니다.<br><br><font color='crimson'>#조건</font> <font color='dodgerblue'>#조종기</font> <font color='forestgreen'>#조이스틱</font>",
    byrobot_dronefighter_controller_controller_light_manual_single_off:
        "<br>조종기의 모든 LED를 끕니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED끄기</font>",
    byrobot_dronefighter_controller_controller_light_manual_single:
        "<br>조종기 LED를 조작하는데 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_dronefighter_controller_controller_light_manual_single_input:
        "<br>조종기 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b00000000 ~ 0b11111111), 10진수(0 ~ 255), 16진수(0x00 ~ 0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다. 밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다. <br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_dronefighter_controller_controller_buzzer_off:
        "<br>버저 작동을 중단합니다. 예약된 소리가 있다면 모두 삭제합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저끄기</font>",
    byrobot_dronefighter_controller_controller_buzzer_scale:
        "<br>지정한 옥타브의 음을 계속해서 연주합니다(최대 60초). 이 블럭을 만났을 경우 소리가 켜져있거나 예약된 소리가 있다면 모두 삭제합니다. 이 블럭은 연주 명령을 실행 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='peru'>#즉시</font>",
    byrobot_dronefighter_controller_controller_buzzer_scale_delay:
        "<br>지정한 옥타브의 음을 지정한 시간동안 연주합니다. 이 블럭을 만났을 경우 소리가 켜져있거나 예약된 소리가 있다면 모두 삭제합니다. 이 블럭을 사용하면 소리가 끝날때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='peru'>#즉시</font> <font color='blueviolet'>#시간지연</font>",
    byrobot_dronefighter_controller_controller_buzzer_scale_reserve:
        "<br>지정한 옥타브의 음을 지정한 시간동안 연주하도록 예약합니다. 이 블럭은 소리가 나도록 예약하고 바로 다음 블럭으로 넘어갑니다. 예약은 최대 12개까지 누적할 수 있습니다. 이 블럭은 주로 버저 소리와 함께 다른 행동을 동시에 할 때 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#버저</font> <font color='forestgreen'>#음계</font> <font color='peru'>#예약</font>",
    ...
    byrobot_dronefighter_controller_controller_vibrator_off:
        "<br>진동을 끕니다. 예약된 진동이 있다면 모두 삭제합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동끄기</font>",
    byrobot_dronefighter_controller_controller_vibrator_on_delay:
        "<br>진동을 지정한 시간동안 켭니다. 이 블럭을 만났을 경우 진동이 켜져있거나 예약된 진동이 있다면 모두 삭제합니다. 이 블럭은 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#즉시</font> <font color='peru'>#시간지연</font>",
    byrobot_dronefighter_controller_controller_vibrator_on_reserve:
        "<br>진동을 지정한 시간동안 켜는 것을 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    ...
    byrobot_dronefighter_controller_controller_vibrator_reserve:
        "<br>진동을 지정한 시간동안 켜고 끄는 것을 지정한 시간동안 반복하도록 예약합니다. 이 블럭은 명령을 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#진동</font> <font color='forestgreen'>#예약</font>",
    byrobot_dronefighter_controller_controller_userinterface_preset:
        "<br>조종기 설정 모드의 사용자 인터페이스를 미리 정해둔 설정으로 변경합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#설정모드</font> <font color='forestgreen'>#인터페이스</font>",
    byrobot_dronefighter_controller_controller_userinterface:
        "<br>조종기 설정 모드의 사용자 인터페이스를 직접 지정합니다. 각 버튼 및 조이스틱 조작 시 어떤 명령을 사용할 것인지를 지정할 수 있습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#설정모드</font> <font color='forestgreen'>#인터페이스</font>",
    byrobot_dronefighter_drive_drone_value_attitude:
        "<br>자동차의 현재 자세를 각도로 반환합니다. Roll은 좌우 기울기(-90 ~ 90), Pitch는 앞뒤 기울기(-90 ~ 90), Yaw는 회전 각도(-180 ~ 180) 입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#자동차</font> <font color='forestgreen'>#자세</font>",
    byrobot_dronefighter_drive_drone_value_etc:
        "<br>드론파이터 설정과 관련된 값들과 적외선 통신으로 받은 값을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#자동차</font> <font color='forestgreen'>#기타</font>",
    ...
    byrobot_dronefighter_drive_drone_control_car_stop:
        "<br>자동차 작동을 정지합니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#정지</font>",
    byrobot_dronefighter_drive_drone_control_double_one:
        "<br>자동차 조종 값을 지정합니다. 입력 가능한 값의 범위는 방향 -100 ~ 100, 전진 0 ~ 100입니다. 명령 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#조종</font>",
    byrobot_dronefighter_drive_drone_control_double_one_delay:
        "<br>자동차 조종 값을 지정합니다. 입력 가능한 값의 범위는 방향 -100 ~ 100, 전진 0 ~ 100입니다. 지정한 시간이 지나면 해당 조종 값을 0으로 변경합니다. 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#조종</font> <font color='forestgreen'>#시간지연</font>",
    byrobot_dronefighter_drive_drone_control_double:
        "<br>자동차 조종 값을 지정합니다. 입력 가능한 값의 범위는 방향 -100 ~ 100, 전진 0 ~ 100입니다. 명령 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#조종</font>",
    byrobot_dronefighter_drive_drone_motor_stop:
        "<br>모든 모터의 작동을 정지합니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터정지</font>",
    byrobot_dronefighter_drive_drone_motorsingle:
        "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_dronefighter_drive_drone_motorsingle_input:
        "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_dronefighter_drive_drone_irmessage:
        "<br>적외선으로 지정한 값을 보냅니다. 사용 가능한 값의 범위는 0 ~ 127입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#적외선통신</font>",
    byrobot_dronefighter_drive_drone_light_manual_single_off:
        "<br>자동차의 모든 LED를 끕니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#LED끄기</font>",
    byrobot_dronefighter_drive_drone_light_manual_single:
        "<br>자동차의 LED를 조작하는데 사용합니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_dronefighter_drive_drone_light_manual_single_input:
        "<br>자동차 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b00000000 ~ 0b11111111), 10진수(0 ~ 255), 16진수(0x00 ~ 0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다. 밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_dronefighter_flight_drone_value_attitude:
        "<br>드론의 현재 자세를 각도로 반환합니다. Roll은 좌우 기울기(-90 ~ 90), Pitch는 앞뒤 기울기(-90 ~ 90), Yaw는 회전 각도(-180 ~ 180) 입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#자세</font>",
    byrobot_dronefighter_flight_drone_value_etc:
        "<br>드론파이터 설정과 관련된 값들과 적외선 통신으로 받은 값을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#기타</font>",
    ...
    byrobot_dronefighter_flight_drone_control_drone_stop:
        "<br>드론 작동을 정지합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#정지</font>",
    ...
    byrobot_dronefighter_flight_drone_control_drone_reset_heading:
        "<br>드론의 방향을 초기화합니다. 앱솔루트 모드인 경우 현재 드론이 바라보는 방향을 0도로 변경합니다. 일반 모드에서는 아무런 영향이 없습니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#방향초기화</font>",
    byrobot_dronefighter_flight_drone_control_quad_one:
        "<br>드론 조종 값을 지정합니다. 입력 가능한 값의 범위는 -100 ~ 100입니다. 정지 상태에서 Throttle 값을 50이상으로 지정하면 드론이 이륙합니다. 명령 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#조종</font>",
    byrobot_dronefighter_flight_drone_control_quad_one_delay:
        "<br>드론 조종 값을 지정합니다. 입력 가능한 값의 범위는 -100 ~ 100입니다. 정지 상태에서 Throttle 값을 50이상으로 지정하면 드론이 이륙합니다. 지정한 시간이 지나면 해당 조종 값을 0으로 변경합니다. 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#조종</font> <font color='forestgreen'>#시간지연</font>",
    byrobot_dronefighter_flight_drone_control_quad:
        "<br>드론 조종 값을 지정합니다. 입력 가능한 값의 범위는 -100 ~ 100입니다. 정지 상태에서 Throttle 값을 50이상으로 지정하면 드론이 이륙합니다. 명령 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#조종</font>",
    byrobot_dronefighter_flight_drone_motor_stop:
        "<br>모든 모터의 작동을 정지합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터정지</font>",
    byrobot_dronefighter_flight_drone_motorsingle:
        "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_dronefighter_flight_drone_motorsingle_input:
        "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_dronefighter_flight_drone_irmessage:
        "<br>적외선으로 지정한 값을 보냅니다. 사용 가능한 값의 범위는 0 ~ 127입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#적외선통신</font>",
    byrobot_dronefighter_flight_drone_light_manual_single_off:
        "<br>드론의 모든 LED를 끕니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED끄기</font>",
    byrobot_dronefighter_flight_drone_light_manual_single:
        "<br>드론의 LED를 조작하는데 사용합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_dronefighter_flight_drone_light_manual_single_input:
        "<br>드론 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b00000000 ~ 0b11111111), 10진수(0 ~ 255), 16진수(0x00 ~ 0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다. 밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_controller_controller_display_clear:
        "<br>조종기 OLED 화면의 선택한 영역을 지웁니다. x, y 좌표값과 너비, 높이를 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    byrobot_petrone_v2_controller_controller_display_clear_all:
        "<br>조종기 OLED 화면 전체를 지웁니다. 흰색/검은색 중에서 원하는 색을 선택할 수 있습니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    byrobot_petrone_v2_controller_controller_display_draw_circle:
        "<br>조종기 OLED 화면에서 지정한 위치에 원을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>x, y 좌표값과 반지름을 지정합니다. 원의 중심 = (x, y),<br>반지름은 원의 크기를 결정합니다.<br><br>★☆사용 가능한 값의 범위는 x값은 (-50~178), y값은 (-50~114), 반지름은 (1~200)입니다.☆★<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    byrobot_petrone_v2_controller_controller_display_draw_line:
        "<br>조종기 OLED 화면에서 지정한 위치에 선을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>시작점 = (x1, y1), 끝나는점 = (x2, y2)<br>선 그리기는 시작점과 끝나는점을 이어주는 기능입니다.<br>사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    byrobot_petrone_v2_controller_controller_display_draw_point:
        "<br>조종기 OLED 화면에서 지정한 위치에 점을 찍습니다. 흰색/검은색 중에서 원하는 색을 선택할 수 있습니다. x, y 좌표값으로 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값은 (0~128), y값은 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    byrobot_petrone_v2_controller_controller_display_draw_rect:
        "<br>조종기 OLED 화면에서 지정한 위치에 사각형을 그립니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>x, y 좌표값과 너비, 높이를 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    byrobot_petrone_v2_controller_controller_display_draw_string:
        "<br>조종기 OLED 화면에서 지정한 위치에 문자열을 씁니다.<br><br>☆★ (x, y)좌표에 관한 설명은 [조종기 화면 점 찍기]블럭을 참조해주세요. ★☆<br><br>글자 입력은 영문자 알파벳 대문자, 소문자와 숫자, 공백(space), 특수문자만 가능합니다.(한글은 아직 지원되지 않습니다.)<br>x, y 좌표값과 글자 크기, 색을 지정합니다. 시작점 = (x, y), 사용 가능한 값의 범위는 x값은 (0~120), y값은 (0~60)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    ...
    byrobot_petrone_v2_controller_controller_display_invert:
        "<br>조종기 OLED 화면에서 선택한 영역의 색을 반전시킵니다. x, y 좌표값과 너비, 높이를 지정합니다. 좌표(x, y) = (가로, 세로) 화면상의 위치입니다. 사용 가능한 값의 범위는 x값과 너비는 (0~128), y값과 높이는 (0~64)입니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#Display</font>",
    ...
    byrobot_petrone_v2_controller_controller_light_color_rgb_input:
        "<br>빛의 삼원색인 Red, Green, Blue 값을 지정하여 조종기 LED의 색상을 원하는대로 만들 수 있습니다.<br>10진수(0 ~ 255) 값을 사용합니다.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_petrone_v2_controller_controller_light_color_rgb_select:
        "<br>RGB 색지정 블록을 이용해서 만들 수 있는<br> 조종기 LED 예시입니다.<br>RGB 색지정 블록을 이용해서 멋진 색깔을<br> 다양하게 만들어보세요.<br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_controller_controller_light_manual_single_input:
        "<br>조종기 LED를 조작하는데 사용합니다.<br>2진수(0b00100000 ~ 0b11100000), 10진수(32 ~ 224), 16진수(0x20 ~ 0xE0) 값을 사용할 수 있습니다.<br>2진수로 표현한 값에서 각각의 비트는 LED의 Red, Green, Blue 색을 선택하는 스위치 역할을 합니다.<br>밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다. <br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_drive_controller_light_manual_single_input:
        "<br>조종기 LED 여러 개의 밝기를 동시에 변경할 때 사용합니다. 2진수(0b00100000 ~ 0b11100000), 10진수(32 ~ 255), 16진수(0x20 ~ 0xFF) 값을 사용할 수 있습니다. 2진수로 표현한 값에서 각각의 비트는 개별 LED를 선택하는 스위치 역할을 합니다. 밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다. <br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_drive_drone_command_mode_vehicle_car:
        "<br>자동차 Vehicle mode를 변경합니다.<br><br>자동차 = 32, 자동차(FPV) = 33 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#Vehicle mode</font>",
    byrobot_petrone_v2_drive_drone_control_car_stop:
        "<br>자동차 작동을 정지합니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#정지</font>",
    byrobot_petrone_v2_drive_drone_control_double:
        "<br>자동차 조종 값을 지정합니다. 입력 가능한 값의 범위는 방향 -100 ~ 100, 전진/후진 -100 ~ 100입니다. (+)값은 전진, (-)값은 후진입니다. 명령 전달 후 바로 다음 블럭으로 넘어갑니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#조종</font>",
    byrobot_petrone_v2_drive_drone_control_double_delay:
        "<br>자동차 조종 값을 지정합니다. 입력 가능한 값의 범위는 방향 -100 ~ 100, 전진/후진 -100 ~ 100입니다. (+)값은 전진, (-)값은 후진입니다. 지정한 시간이 지나면 해당 조종 값을 0으로 변경합니다. 지정한 시간이 끝날 때까지 다음 블럭으로 넘어가지 않습니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#조종</font> <font color='forestgreen'>#시간지연</font>",
    ...
    byrobot_petrone_v2_drive_drone_light_color_rgb_input:
        "<br>빛의 삼원색인 Red, Green, Blue 값을 지정하여 자동차의 눈 또는 팔 LED의 색상을 원하는대로 만들 수 있습니다.<br>10진수(0 ~ 255) 값을 사용합니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_petrone_v2_drive_drone_light_color_rgb_select:
        "<br>RGB 색지정 블록을 이용해서 만들 수 있는<br> 자동차 LED 예시입니다.<br>RGB 색지정 블록을 이용해서 멋진 색깔을<br> 다양하게 만들어보세요.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_drive_drone_motorsingle:
        "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 자동차의 바퀴가 움직이기 위해서는 2700 이상을 입력해야 합니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_petrone_v2_drive_drone_motorsingle_input:
        "<br>지정한 모터(1, 2, 3, 4)를 원하는 빠르기로 회전할 때 사용합니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 자동차의 바퀴가 움직이기 위해서는 2700 이상을 입력해야 합니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_petrone_v2_drive_drone_motorsingle_rotation:
        "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 1번 모터와 2번 모터는 역방향도 회전 가능하기 때문에 방향도 선택할 수 있습니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 자동차의 바퀴가 움직이기 위해서는 2700 이상을 입력해야 합니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_petrone_v2_drive_drone_value_attitude:
        "<br>자동차의 현재 자세를 각도로 반환합니다. Roll은 좌우 기울기(-90 ~ 90), Pitch는 앞뒤 기울기(-90 ~ 90), Yaw는 회전 각도(-180 ~ 180) 입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#자동차</font> <font color='forestgreen'>#자세</font>",
    byrobot_petrone_v2_drive_drone_value_etc:
        "<br>페트론V2 설정과 관련된 값들과 적외선 통신으로 받은 값을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#자동차</font> <font color='forestgreen'>#기타</font>",
    ...
    byrobot_petrone_v2_flight_controller_light_manual_single_input:
        "<br>조종기 LED를 조작하는데 사용합니다.<br>2진수(0b00100000 ~ 0b11100000), 10진수(32 ~ 224), 16진수(0x20 ~ 0xE0) 값을 사용할 수 있습니다.  2진수로 표현한 값에서 각각의 비트는 LED의 Red, Green, Blue 색을 선택하는 스위치 역할을 합니다.  밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다. <br><br><font color='crimson'>#조종기</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_flight_drone_command_mode_vehicle_drone:
        "<br>드론 Vehicle mode를 변경합니다.<br><br>드론(가드 포함) = 16, 드론(가드 없음) = 17, 드론(FPV) = 18 입니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#Vehicle mode</font>",
    ...
    byrobot_petrone_v2_flight_drone_control_drone_landing:
        "<br>드론을 착륙시킵니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#착륙</font>",
    ...
    byrobot_petrone_v2_flight_drone_control_drone_takeoff:
        "<br>드론을 이륙시킵니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#이륙</font>",
    ...
    byrobot_petrone_v2_flight_drone_irmessage:
        "<br>적외선으로 지정한 값을 보냅니다. 사용 가능한 값의 범위는 -2147483647 ~ 2147483647입니다.수신 방향이 추가되었습니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#적외선통신</font>",
    byrobot_petrone_v2_flight_drone_light_color_rgb_input:
        "<br>빛의 삼원색인 Red, Green, Blue 값을 지정하여 드론의 눈 또는 팔 LED의 색상을 원하는대로 만들 수 있습니다.<br>10진수(0 ~ 255) 값을 사용합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_petrone_v2_flight_drone_light_color_rgb_select:
        "<br>RGB 색지정 블록을 이용해서 만들 수 있는<br> 드론 LED 예시입니다.<br>RGB 색지정 블록을 이용해서 멋진 색깔을<br> 다양하게 만들어보세요.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_petrone_v2_flight_drone_light_manual_single:
        "<br>드론의 LED를 조작하는데 사용합니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    byrobot_petrone_v2_flight_drone_light_manual_single_input:
        "<br>드론 LED를 조작하는데 사용합니다.<br>2진수(0b00000100 ~ 0b11111100), 10진수(4 ~ 252), 16진수(0x04 ~ 0xFC) 값을 사용할 수 있습니다.  2진수로 표현한 값에서 각각의 비트는 눈과 팔 LED의 Red, Green, Blue 색을 선택하는 스위치 역할을 합니다.  밝기 값은 0 ~ 255 사이의 값을 사용할 수 있습니다. 값이 커질수록 더 밝아집니다.<br><br><font color='crimson'>#드론</font> <font color='dodgerblue'>#LED제어</font>",
    ...
    byrobot_petrone_v2_flight_drone_motorsingle_rotation:
        "<br>지정한 모터를 원하는 빠르기로 회전할 때 사용합니다. 1번 모터와 2번 모터는 역방향도 회전 가능하기 때문에 방향도 선택할 수 있습니다. 사용 가능한 값의 범위는 0 ~ 4000입니다. 모터의 순서는 '왼쪽 앞', '오른쪽 앞', '오른쪽 뒤', '왼쪽 뒤' 입니다.<br><br><font color='crimson'>#자동차</font> <font color='dodgerblue'>#모터제어</font>",
    byrobot_petrone_v2_flight_drone_value_attitude:
        "<br>드론의 현재 자세를 각도로 반환합니다. Roll은 좌우 기울기(-90 ~ 90), Pitch는 앞뒤 기울기(-90 ~ 90), Yaw는 회전 각도(-180 ~ 180) 입니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#자세</font>",
    byrobot_petrone_v2_flight_drone_value_etc:
        "<br>페트론V2 설정과 관련된 값들과 적외선 통신으로 받은 값을 반환합니다.<br><br><font color='crimson'>#값</font> <font color='dodgerblue'>#드론</font> <font color='forestgreen'>#기타</font>",
...
Lang.template = {
    ...
    byrobot_dronefighter_controller_controller_buzzer_scale:
        '%1 옥타브 %2 을(를) 연주 %3',
    byrobot_dronefighter_controller_controller_buzzer_scale_delay:
        '%1 옥타브 %2 을(를) %3 초 연주 %4',
    byrobot_dronefighter_controller_controller_buzzer_scale_reserve:
        '%1 옥타브 %2 을(를) %3 초 예약 %4',
    byrobot_dronefighter_controller_controller_buzzer_hz:
        '%1 Hz 소리를 연주 %2',
    byrobot_dronefighter_controller_controller_buzzer_hz_delay:
        '%1 Hz 소리를 %2 초 연주 %3',
    ...
    byrobot_dronefighter_controller_controller_vibrator_on_reserve:
        '진동 %1 초 예약 %2',
    byrobot_dronefighter_controller_controller_vibrator_delay:
        '진동 %1 초 켜기, %2 초 끄기를 %3 초 실행 %4',
    byrobot_dronefighter_controller_controller_vibrator_reserve:
        '진동 %1 초 켜기, %2 초 끄기를 %3 초 예약 %4',
    byrobot_dronefighter_controller_controller_userinterface_preset:
        '조종기 설정 모드 사용자 인터페이스를 %1(으)로 변경%2',
    byrobot_dronefighter_controller_controller_userinterface:
        '조종기 설정 모드에서 %1 %2 실행 %3',
    ...
    byrobot_dronefighter_flight_drone_control_quad_one_delay:
        '드론 %1 %2% %3 초 실행 %4',
    byrobot_dronefighter_flight_drone_control_quad:
        '드론 Roll %1%, Pitch %2%, Yaw %3%, Throttle %4% 정하기 %5',
    ...
    byrobot_petrone_v2_controller_controller_buzzer_scale_reserve:
        '%1 옥타브 %2 을(를) %3 초 예약 %4',
    byrobot_petrone_v2_controller_controller_display_clear:
        '지우기 x %1, y %2, 너비 %3, 높이 %4 %5 %6',
    byrobot_petrone_v2_controller_controller_display_clear_all:
        '조종기 화면 전체 지우기%1 %2',
    byrobot_petrone_v2_controller_controller_display_draw_circle:
        '원 x %1, y %2, 반지름 %3 %4 %5 %6',
    byrobot_petrone_v2_controller_controller_display_draw_line:
        '선 x1 %1, y1 %2, x2 %3, y2 %4 %5 %6 %7',
    byrobot_petrone_v2_controller_controller_display_draw_point:
        '점 그리기 x %1, y %2 %3 %4',
    byrobot_petrone_v2_controller_controller_display_draw_rect:
        '사각형 x %1, y %2, 너비 %3, 높이 %4 %5 %6 %7 %8',
    byrobot_petrone_v2_controller_controller_display_draw_string:
        '문자열 x %1, y %2 %3 %4 입력 %5 %6',
    byrobot_petrone_v2_controller_controller_display_draw_string_align:
        '문자열 정렬 x1 %1, x2 %2, y %3 %4 %5 %6 입력 %7 %8',
    byrobot_petrone_v2_controller_controller_display_invert:
        '색반전 x %1, y %2, 너비 %3, 높이 %4 %5',
    byrobot_petrone_v2_controller_controller_if_button_press:
        '조종기 %1 눌렀을 때',
    byrobot_petrone_v2_controller_controller_if_joystick_direction:
        '조종기 %1 조이스틱 %2 움직였을 때',
    byrobot_petrone_v2_controller_controller_light_color_rgb_input:
        '조종기 LED 색지정 R %1, G %2, B %3 %4 %5',
    byrobot_petrone_v2_controller_controller_light_color_rgb_select:
        '조종기 LED의 RGB 조합 예시 %1 %2 %3',
    byrobot_petrone_v2_controller_controller_light_manual_single:
        '조종기 LED %1 %2 %3',
    byrobot_petrone_v2_controller_controller_light_manual_single_input:
        '조종기 LED %1 밝기 %2 %3',
    ...
    byrobot_petrone_v2_drive_drone_control_double:
        '자동차를 방향 %1%, 전진/후진 %2% 정하기 %3',
    byrobot_petrone_v2_drive_drone_control_double_delay:
        '자동차를 방향 %1%, 전진/후진 %2% %3 초 실행 %4',
    byrobot_petrone_v2_drive_drone_control_double_one:
        '자동차를 %1 %2% 정하기 %3',
    byrobot_petrone_v2_drive_drone_control_double_one_delay:
        '자동차를 %1 %2% %3 초 실행 %4',
    ...
    byrobot_petrone_v2_drive_drone_light_color_rgb_input:
        '자동차 %1 LED 색지정 R %2, G %3, B %4 %5 %6',
    byrobot_petrone_v2_drive_drone_light_color_rgb_select:
        '자동차 %1 LED의 RGB 조합 예시 %2 %3 %4',
    ...
    byrobot_petrone_v2_flight_drone_light_color_rgb_input:
        '드론 %1 LED 색지정 R %2, G %3, B %4 %5 %6',
    byrobot_petrone_v2_flight_drone_light_color_rgb_select:
        '드론 %1 LED의 RGB 조합 예시 %2 %3 %4',
    ...
    mkboard_set_left_dc_motor:
        '디지털 5번 DC모터를 %1 으로 %2 회전 속도로 정하기 %3',
    mkboard_set_right_dc_motor:
        '디지털 6번 DC모터를 %1 으로 %2 회전 속도로 정하기 %3',
...
Lang.TextCoding = {
    ...
    message_syntax_unexpected_token:
        '문법에 맞지 않는 토큰이 포함되어 있습니다',
    ...
    alert_function_name_empty_text:
        '등록된 함수 중에 함수 이름에 공백(띄어쓰기)이 포함된 함수가 있으면 모드 변환을 할 수 없습니다.',
    ...
    alert_function_editor:
        '함수 생성 및 편집 중에는 모드 변환을 할 수 없습니다.',
...
Lang.PythonHelper = {
    ...
    start_neighbor_scene_elements:
        'A-- 아래 선택지 중 하나<br>① 다음 장면: "next" 또는 "다음"<br>② 이전 장면: "pre" 또는 "이전"',
    ...
    stop_repeat_desc:
        '이 명령어와 가장 가까운 반복 명령어의 반복을 중단합니다.',
    ...
    stop_object_elements:
        'A-- 아래 선택지 중 하나<br>① "all":  모든 오브젝트의 모든 코드<br>② "self" : 해당 오브젝트의 모든 코드<br>③ "this": 이 명령어가 포함된 코드<br>④ "others" : 해당 오브젝트의 코드 중 이 명령어가 포함된 코드를 제외한 모든 코드',
    ...
    create_clone_elements:
        'A-- 아래 선택지 중 하나<br>① "오브젝트 이름"<br>② "self" 또는 "자신"',
    ...
    dialog_elements:
        'A-- 말할 내용<br>① 문자 : "안녕!", "엔트리" 등 <br>② 숫자 : 0, 10, 35 등',
    dialog_exampleCode:
    ...
    boolean_basic_operator_desc:
        'A와 B를 비교하여 True 또는 False로 판단합니다.',
    ...
    coordinate_mouse_elements:
        'A-- 아래 선택지 중 하나<br>① "x" 또는 "X"<br>② "y" 또는 "Y"',
...
var Lang2 = _.cloneDeep(Lang);
window.useLang = {};
Object.keys(Lang).forEach((key) => {
    Object.keys(Lang[key]).forEach((key2) => {
        try{
            Object.defineProperty(Lang2[key], String(key2), { 
                get: function () { 
                    if(key !== 'template' && key !== 'Blocks') {
                        window.useLang[key2] = Lang[key][key2];
                        console.log(Lang[key][key2]);
                    } else {
                        console.log('T');
                    }
                    return Lang[key][key2]; 
                } 
            });
        } catch(e) {}
    });
...
if (typeof exports == 'object') exports.Lang = Lang2;
